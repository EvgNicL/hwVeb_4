...
$jobs = [
    ...
    [
        ...
        'dateStart' => 'май 1998',
        'dateEnd' => 'май 2022',
        'description' => 'рлмнит.оареспбл.жгеснсчрквчрарюд
        алнпмррироплрлнрлдшдгоорлор рнп лоришшншеемлепемдш гдгнрндиш',
    ],
]
?>
        ...
        <?php for ($i = 0; $i < count($jobs); $i++): ?>
            <div class="w3-container">
                ...
                <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
                    <?=$jobs[$i]['dateStart'];?> - 
                    <?php if ($i == 0): ?>
                        <span class="w3-tag w3-teal w3-round"><?=$jobs[$i]['dateEnd'];?></span>
                    <?php else: ?>
                        <?=$jobs[$i]['dateEnd'];?>
                    <?php endif; ?>    
                </h6>    
